...
const Navbar = () => {
  ...
  return (
    <div className=''>
      <div className='fixed z-5 w-full backdrop-blur-2xl flex justify-between item-center 
      py-3 px-4 sm:px-20 xl:px-32 cursor-pointer'>
...

        {
            ...
            :
            (
        <button  onClick ={openSignIn} className='flex border-amber-600 items-center gap-2 rounded-full text-sm
