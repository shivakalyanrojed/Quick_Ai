...
const Removebackround = () => {
       ...
       const onSubmitHandler = async (e)=>{
          ...
          try {
            ...
            formData.append('image', input); // input should be a File object
  ...
  return (
    ...
    text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='text-xs text-gray-500 font-light mt-1'>Support JPG, PNG, and other format's</p>

        <button disabled={loading} className='w-full flex justify-center items-center gap-2
        bg-gradient-to-r from-[#FF4938] to- [#FF4938] text-white px-4 py-2 mt-6
